...
import chapter16.dao.ResourceDao;
...
public class ResourceDaoImpl implements ResourceDao {
    ...
    public Resource updateResource(Resource resource) {
        ...
        jt.update(sql, resource.getName(), resource.getType().name(), resource.getUrl(), resource.getPermission(), resource.getParentId(), resource.getParentIds(), resource.getAvailable(), resource.getId());
        return resource;
    }
    ...
    public List<Resource> findAll() {
        ...
        return jt.query(sql, new BeanPropertyRowMapper<Resource>(Resource.class));
    }
}
